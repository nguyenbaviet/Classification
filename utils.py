...
def get_args(is_train=True):
    ...
    # for test
    parser.add_argument(
        "--eval_data", required=not is_train, help="path to evaluation dataset"
    )
    parser.add_argument(
        "--benchmark_all_eval",
        action="store_true",
    ...
    parser.add_argument(
        "--calculate_infer_time", action="store_true", help="calculate inference timing"
    )
    parser.add_argument(
        "--flops", action="store_true", help="calculates approx flops (may not work)"
    )

    # for train
    parser.add_argument("--exp_name", help="Where to store logs and models")
    parser.add_argument(
        "--train_data", required=is_train, help="path to training dataset"
    )
    parser.add_argument(
        "--valid_data", required=is_train, help="path to validation dataset"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--workers",
        type=int,
        help="number of data loading workers. Use -1 to use all cores.",
        default=4,
    )
    ...
    parser.add_argument(
        "--sgd", action="store_true", help="Whether to use SGD (default is Adadelta)"
    )
    parser.add_argument(
    ...
    """ Model Architecture """
    parser.add_argument(
        "--Transformer", action="store_true", help="Use end-to-end transformer"
    )
    ...
    parser.add_argument(
        "--TransformerModel",
        default=choices[0],
        help="Which vit/deit transformer model",
        choices=choices,
    )
    parser.add_argument(
        "--Transformation",
    ...
    parser.add_argument(
        "--Prediction", type=str, required=True, help="Prediction stage. None|CTC|Attn"
    )
    parser.add_argument(
        "--num_fiducial",
        type=int,
    ...
    parser.add_argument(
        "--process", action="store_true", help="Image processing routines"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.5,
        help="Probability of not applying augmentation",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=3,
        help="Number of data augment groups to apply. 1 to 8.",
    )
    parser.add_argument(
        "--augs_mag",
        type=int,
    ...
    parser.add_argument(
        "--fast_acc", action="store_true", help="Fast average accuracy computation"
    )
